...
/* 224 */     return new Color(250, 248, 190);
/*     */   }
/*     */   
/*     */   public static final Color getAlternateClientColor() {
/* 228 */     return new Color(46, 234, 255);
/*     */   }
/*     */   
/*     */   public static final Color getTenacityColor() {
/* 232 */     return new Color(236, 133, 209);
/*     */   }
/*     */   
/*     */   public static final Color getAlternateTenacityColor() {
/* 236 */     return new Color(28, 167, 222);
/*     */   }
/*     */   
/*     */   public static void resetColor() {
/* 240 */     GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
/*     */   }
/*     */   
/*     */   public static Color rainbow(int speed, int index, float saturation, float brightness, float opacity) {
/* 244 */     int angle = (int)((System.currentTimeMillis() / speed + index) % 360L);
/* 245 */     float hue = angle / 360.0F;
/* 246 */     Color color = new Color(Color.HSBtoRGB(hue, saturation, brightness));
/* 247 */     return new Color(color.getRed(), color.getGreen(), color.getBlue(), Math.max(0, Math.min(255, (int)(opacity * 255.0F))));
/*     */   }
/*     */   
/*     */   public static Color rainbow(int speed, int index, float saturation, float brightness, float opacity, int alp) {
/* 251 */     int angle = (int)((System.currentTimeMillis() / speed + index) % 360L);
/* 252 */     float hue = angle / 360.0F;
/* 253 */     Color color = new Color(Color.HSBtoRGB(hue, saturation, brightness));
/* 254 */     return new Color(color.getRed(), color.getGreen(), color.getBlue(), alp);
/*     */   }
/*     */   
/*     */   public static int darker(int hexColor, int factor) {
/* 258 */     float alpha = (hexColor >> 24 & 0xFF);
/* 259 */     float red = Math.max((hexColor >> 16 & 0xFF) - (hexColor >> 16 & 0xFF) / 100.0F / factor, 0.0F);
/* 260 */     float green = Math.max((hexColor >> 8 & 0xFF) - (hexColor >> 8 & 0xFF) / 100.0F / factor, 0.0F);
/* 261 */     float blue = Math.max((hexColor & 0xFF) - (hexColor & 0xFF) / 100.0F / factor, 0.0F);
/* 262 */     return (int)((((int)alpha << 24) + ((int)red << 16) + ((int)green << 8)) + blue);
/*     */   }
/*     */   
/*     */   public static Color interpolateColorsBackAndForth(int speed, int index, Color start, Color end, boolean trueColor) {
/* 266 */     int angle = (int)((System.currentTimeMillis() / speed + index) % 360L);
/* 267 */     angle = ((angle >= 180) ? (360 - angle) : angle) * 2;
/* 268 */     return trueColor ? interpolateColorHue(start, end, angle / 360.0F) : interpolateColorC(start, end, angle / 360.0F);
/*     */   }
/*     */   
/*     */   public static Color interpolateColorC(Color color1, Color color2, float amount) {
/* 272 */     amount = Math.min(1.0F, Math.max(0.0F, amount));
/* 273 */     return new Color(MathUtil.interpolateInt(color1.getRed(), color2.getRed(), amount), MathUtil.interpolateInt(color1.getGreen(), color2.getGreen(), amount), MathUtil.interpolateInt(color1.getBlue(), color2.getBlue(), amount), MathUtil.interpolateInt(color1.getAlpha(), color2.getAlpha(), amount));
/*     */   }
/*     */   
/*     */   public static int applyOpacityInt(int color, float opacity) {
/* 277 */     Color old = new Color(color);
/* 278 */     return applyOpacityInt(old, opacity).getRGB();
/*     */   }
/*     */   
/*     */   public static Color applyOpacityColor(int color, float opacity) {
/* 282 */     Color old = new Color(color);
/* 283 */     return applyOpacityInt(old, opacity);
/*     */   }
/*     */   
/*     */   public static int interpolateColor(int color1, int color2, float amount) {
/* 287 */     amount = Math.min(1.0F, Math.max(0.0F, amount));
/* 288 */     Color cColor1 = new Color(color1);
/* 289 */     Color cColor2 = new Color(color2);
/* 290 */     return interpolateColorC(cColor1, cColor2, amount).getRGB();
/*     */   }
/*     */   
/*     */   public static Color interpolateColorHue(Color color1, Color color2, float amount) {
/* 294 */     amount = Math.min(1.0F, Math.max(0.0F, amount));
/* 295 */     float[] color1HSB = Color.RGBtoHSB(color1.getRed(), color1.getGreen(), color1.getBlue(), null);
/* 296 */     float[] color2HSB = Color.RGBtoHSB(color2.getRed(), color2.getGreen(), color2.getBlue(), null);
/* 297 */     Color resultColor = Color.getHSBColor(MathUtil.interpolateFloat(color1HSB[0], color2HSB[0], amount), MathUtil.interpolateFloat(color1HSB[1], color2HSB[1], amount), MathUtil.interpolateFloat(color1HSB[2], color2HSB[2], amount));
/* 298 */     return new Color(resultColor.getRed(), resultColor.getGreen(), resultColor.getBlue(), MathUtil.interpolateInt(color1.getAlpha(), color2.getAlpha(), amount));
/*     */   }
/*     */   
/*     */   public static Color applyOpacityInt(Color color, float opacity) {
/* 302 */     opacity = Math.min(1.0F, Math.max(0.0F, opacity));
/* 303 */     return new Color(color.getRed(), color.getGreen(), color.getBlue(), (int)(color.getAlpha() * opacity));
/*     */   }
/*     */   
/*     */   public static int getColor(int brightness) {
/* 307 */     return getColor(brightness, brightness, brightness, 255);
/*     */   }
/*     */   
/*     */   public static int getColor(int brightness, int alpha) {
/* 311 */     return getColor(brightness, brightness, brightness, alpha);
/*     */   }
/*     */   
/*     */   public static Color getClientColor(float yStep, float astolfoastep, float yStepFull, int speed) {
/* 315 */     Color color = Color.white;
/* 316 */     color = astolfo(astolfoastep, yStepFull, 0.5F, speed);
/* 317 */     return color;
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\Downloads\Awareline - NextGen7 release ‎2023‎-12-25-‏11-09-05.jar!\awareline\mai\\utility\render\render\ColorUtils.class
