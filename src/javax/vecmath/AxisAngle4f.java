...
/*     */     try {
/* 455 */       return (this.x == a1.x && this.y == a1.y && this.z == a1.z && this.angle == a1.angle);
...
/* 474 */       return (this.x == a2.x && this.y == a2.y && this.z == a2.z && this.angle == a2.angle); }
/*     */     catch (NullPointerException e2)
/*     */     
/* 477 */     { return false; }
...
/* 505 */     return (((diff < 0.0F) ? -diff : diff) <= epsilon);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   public int hashCode() {
/* 520 */     long bits = 1L;
/* 521 */     bits = VecMathUtil.hashFloatBits(bits, this.x);
/* 522 */     bits = VecMathUtil.hashFloatBits(bits, this.y);
/* 523 */     bits = VecMathUtil.hashFloatBits(bits, this.z);
/* 524 */     bits = VecMathUtil.hashFloatBits(bits, this.angle);
/* 525 */     return VecMathUtil.hashFinish(bits);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Administrator\Downloads\Awareline - NextGen7 release ‎2023‎-12-25-‏11-09-05.jar!\javax\vecmath\AxisAngle4f.class
