...
/*     */     try {
/* 460 */       return (this.x == a1.x && this.y == a1.y && this.z == a1.z && this.angle == a1.angle);
...
/*     */     try {
/* 477 */       AxisAngle4d a2 = (AxisAngle4d)o1;
/* 478 */       return (this.x == a2.x && this.y == a2.y && this.z == a2.z && this.angle == a2.angle);
...
/* 499 */     double diff = this.x - a1.x;
/* 500 */     if (((diff < 0.0D) ? -diff : diff) > epsilon) return false;
/*     */     
/* 502 */     diff = this.y - a1.y;
/* 503 */     if (((diff < 0.0D) ? -diff : diff) > epsilon) return false;
/*     */     
/* 505 */     diff = this.z - a1.z;
/* 506 */     if (((diff < 0.0D) ? -diff : diff) > epsilon) return false;
/*     */     
/* 508 */     diff = this.angle - a1.angle;
/* 509 */     return (((diff < 0.0D) ? -diff : diff) <= epsilon);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   public int hashCode() {
/* 523 */     long bits = 1L;
/* 524 */     bits = VecMathUtil.hashDoubleBits(bits, this.x);
/* 525 */     bits = VecMathUtil.hashDoubleBits(bits, this.y);
/* 526 */     bits = VecMathUtil.hashDoubleBits(bits, this.z);
/* 527 */     bits = VecMathUtil.hashDoubleBits(bits, this.angle);
/* 528 */     return VecMathUtil.hashFinish(bits);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Administrator\Downloads\Awareline - NextGen7 release ‎2023‎-12-25-‏11-09-05.jar!\javax\vecmath\AxisAngle4d.class
