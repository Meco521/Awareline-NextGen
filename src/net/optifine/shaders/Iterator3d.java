...
/*  12 */   private final BlockPosM blockPos = new BlockPosM(0, 0, 0);
...
/*  49 */       double d9 = (posEnd.getY() - posStart.getY()) / k;
/*  50 */       double d11 = (posEnd.getX() - posStart.getX()) / k;
...
/*  59 */       double d8 = (posEnd.getX() - posStart.getX()) / j;
/*  60 */       double d10 = (posEnd.getZ() - posStart.getZ()) / j;
...
/*  69 */       double d6 = (posEnd.getY() - posStart.getY()) / i;
/*  70 */       double d7 = (posEnd.getZ() - posStart.getZ()) / i;
