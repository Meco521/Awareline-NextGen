...
/*  92 */     clearResources();
/*  93 */     logger.info("Reloading ResourceManager: " + joinerResourcePacks.join(Iterables.transform(resourcesPacksList, new Function<IResourcePack, String>()
/*     */             {
/*     */               public String apply(IResourcePack p_apply_1_)
/*     */               {
/*  97 */                 return p_apply_1_.getPackName();
/*     */               }
/*     */             })));
/*     */     
