...
/*     */   extends GuiScreen implements IProgressMeter {
/*  29 */   private static final int field_146572_y = AchievementList.minDisplayColumn * 24 - 112;
/*  30 */   private static final int field_146571_z = AchievementList.minDisplayRow * 24 - 112;
/*  31 */   private static final int field_146559_A = AchievementList.maxDisplayColumn * 24 - 77;
/*  32 */   private static final int field_146560_B = AchievementList.maxDisplayRow * 24 - 77;
/*  33 */   private static final ResourceLocation ACHIEVEMENT_BACKGROUND = new ResourceLocation("textures/gui/achievement/achievement_background.png");
/*     */   protected GuiScreen parentScreen;
/*  35 */   protected int field_146555_f = 256;
/*  36 */   protected int field_146557_g = 202;
/*     */   protected int field_146563_h;
/*     */   protected int field_146564_i;
/*  39 */   protected float field_146570_r = 1.0F;
/*     */   
...
/*  52 */     this.parentScreen = parentScreenIn;
/*  53 */     this.statFileWriter = statFileWriterIn;
/*  54 */     int i = 141;
/*  55 */     int j = 141;
/*  56 */     this.field_146569_s = this.field_146567_u = this.field_146565_w = (AchievementList.openInventory.displayColumn * 24 - i / 2 - 12);
/*  57 */     this.field_146568_t = this.field_146566_v = this.field_146573_x = (AchievementList.openInventory.displayRow * 24 - j / 2);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   public void initGui() {
/*  66 */     this.mc.getNetHandler().addToSendQueue((Packet)new C16PacketClientStatus(C16PacketClientStatus.EnumState.REQUEST_STATS));
/*  67 */     this.buttonList.clear();
/*  68 */     this.buttonList.add(new GuiOptionButton(1, this.width / 2 + 24, this.height / 2 + 74, 80, 20, I18n.format("gui.done", new Object[0])));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/*  92 */       this.mc.displayGuiScreen((GuiScreen)null);
...
/* 110 */       drawCenteredString(this.fontRendererObj, lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % lanSearchStates.length)], this.width / 2, this.height / 2 + (this.fontRendererObj.FONT_HEIGHT << 1), 16777215);
/*     */     }
/*     */     else {
/*     */       
...
/*     */         
/* 299 */         random.setSeed((this.mc.getSession().getPlayerID().hashCode() + k1 + i4 + (l1 + l3 << 4)));
...
/* 340 */         drawTexturedModalRect((i4 << 4) - i2, (l3 << 4) - j2, textureatlassprite, 16, 16);
/*     */       } 
/*     */     } 
/*     */     
...
/* 462 */           this.itemRender.isNotRenderingEffectsInGUI(false);
/*     */         } 
/*     */         
...
/*     */         {
/* 473 */           this.itemRender.isNotRenderingEffectsInGUI(true);
/*     */         }
/*     */         
