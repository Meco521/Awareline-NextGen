...
/* 68 */     for (int i = 0; i < getSize(); i++) {
/*    */       
/* 70 */       int j = this.left + this.width / 2 - getListWidth() / 2 + 2;
/* 71 */       int k = this.top + 4 - getAmountScrolled() + i * this.slotHeight + this.headerPadding;
/* 72 */       int l = p_148181_1_ - j;
/* 73 */       int i1 = p_148181_2_ - k;
/* 74 */       getListEntry(i).mouseReleased(i, p_148181_1_, p_148181_2_, p_148181_3_, l, i1);
/*    */     } 
/*    */     
/* 77 */     setEnabled(true);
/* 78 */     return false;
