...
/*     */   extends GuiScreen {
/*  27 */   static final List<LayerItem> FLAT_WORLD_PRESETS = Lists.newArrayList();
/*     */   
...
/*  40 */     this.parentScreen = p_i46318_1_;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  54 */     this.field_146433_u = new GuiTextField(2, this.fontRendererObj, 50, 40, this.width - 100, 20);
...
/*  58 */     this.buttonList.add(this.field_146434_t = new GuiButton(0, this.width / 2 - 155, this.height - 28, 150, 20, I18n.format("createWorld.customize.presets.select", new Object[0])));
...
/*  69 */     this.field_146435_s.handleMouseInput();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  85 */     this.field_146433_u.mouseClicked(mouseX, mouseY, mouseButton);
...
/*  95 */     if (!this.field_146433_u.textboxKeyTyped(typedChar, keyCode))
/*     */     {
...
/* 246 */       worldrenderer.pos(p_148171_1_, (p_148171_2_ + 18), GuiFlatPresets.this.zLevel).tex((p_148171_3_ * 0.0078125F), ((p_148171_4_ + 18) * 0.0078125F)).endVertex();
...
/* 248 */       worldrenderer.pos((p_148171_1_ + 18), p_148171_2_, GuiFlatPresets.this.zLevel).tex(((p_148171_3_ + 18) * 0.0078125F), (p_148171_4_ * 0.0078125F)).endVertex();
/* 249 */       worldrenderer.pos(p_148171_1_, p_148171_2_, GuiFlatPresets.this.zLevel).tex((p_148171_3_ * 0.0078125F), (p_148171_4_ * 0.0078125F)).endVertex();
