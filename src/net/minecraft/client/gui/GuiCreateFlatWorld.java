...
/*  23 */   FlatGeneratorInfo theFlatGeneratorInfo = FlatGeneratorInfo.getDefaultFlatGenerator();
/*     */   
...
/*  42 */     return this.theFlatGeneratorInfo.toString();
/*     */   }
/*     */ 
/*     */   
/*     */   public void func_146383_a(String p_146383_1_) {
/*  47 */     this.theFlatGeneratorInfo = FlatGeneratorInfo.createFlatGeneratorFromString(p_146383_1_);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  57 */     this.flatWorldTitle = I18n.format("createWorld.customize.flat.title", new Object[0]);
/*  58 */     this.field_146394_i = I18n.format("createWorld.customize.flat.tile", new Object[0]);
/*  59 */     this.field_146391_r = I18n.format("createWorld.customize.flat.height", new Object[0]);
/*  60 */     this.createFlatWorldListSlotGui = new Details();
/*  61 */     this.buttonList.add(this.field_146389_t = new GuiButton(2, this.width / 2 - 154, this.height - 52, 100, 20, I18n.format("createWorld.customize.flat.addLayer", new Object[0]) + " (NYI)"));
/*  62 */     this.buttonList.add(this.field_146388_u = new GuiButton(3, this.width / 2 - 50, this.height - 52, 100, 20, I18n.format("createWorld.customize.flat.editLayer", new Object[0]) + " (NYI)"));
/*  63 */     this.buttonList.add(this.field_146386_v = new GuiButton(4, this.width / 2 - 155, this.height - 52, 150, 20, I18n.format("createWorld.customize.flat.removeLayer", new Object[0])));
/*  64 */     this.buttonList.add(new GuiButton(0, this.width / 2 - 155, this.height - 28, 150, 20, I18n.format("gui.done", new Object[0])));
/*  65 */     this.buttonList.add(new GuiButton(5, this.width / 2 + 5, this.height - 52, 150, 20, I18n.format("createWorld.customize.presets", new Object[0])));
/*  66 */     this.buttonList.add(new GuiButton(1, this.width / 2 + 5, this.height - 28, 150, 20, I18n.format("gui.cancel", new Object[0])));
/*  67 */     this.field_146388_u.visible = false;
/*  68 */     this.theFlatGeneratorInfo.func_82645_d();
/*  69 */     func_146375_g();
/*     */   }
/*     */ 
/*     */ 
...
/*  78 */     this.createFlatWorldListSlotGui.handleMouseInput();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 178 */       worldrenderer.pos(p_148224_1_, (p_148224_2_ + 18), GuiCreateFlatWorld.this.zLevel).tex((p_148224_3_ * 0.0078125F), ((p_148224_4_ + 18) * 0.0078125F)).endVertex();
...
/* 180 */       worldrenderer.pos((p_148224_1_ + 18), p_148224_2_, GuiCreateFlatWorld.this.zLevel).tex(((p_148224_3_ + 18) * 0.0078125F), (p_148224_4_ * 0.0078125F)).endVertex();
/* 181 */       worldrenderer.pos(p_148224_1_, p_148224_2_, GuiCreateFlatWorld.this.zLevel).tex((p_148224_3_ * 0.0078125F), (p_148224_4_ * 0.0078125F)).endVertex();
...
/* 208 */       IBlockState iblockstate = flatlayerinfo.getLayerMaterial();
