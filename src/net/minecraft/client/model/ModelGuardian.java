...
/*  73 */     float f = ageInTicks - entityguardian.ticksExisted;
/*  74 */     this.guardianBody.rotateAngleY = netHeadYaw / 57.295776F;
/*  75 */     this.guardianBody.rotateAngleX = headPitch / 57.295776F;
...
/*  89 */       (this.guardianSpines[i]).rotationPointX = afloat3[i] * (1.0F + MathHelper.cos(ageInTicks * 1.5F + i) * 0.01F - f1);
/*  90 */       (this.guardianSpines[i]).rotationPointY = 16.0F + afloat4[i] * (1.0F + MathHelper.cos(ageInTicks * 1.5F + i) * 0.01F - f1);
/*  91 */       (this.guardianSpines[i]).rotationPointZ = afloat5[i] * (1.0F + MathHelper.cos(ageInTicks * 1.5F + i) * 0.01F - f1);
/*     */     } 
/*     */     
