...
/*    */       
/* 49 */       (this.blazeSticks[i]).rotationPointY = -2.0F + MathHelper.cos(((i << 1) + ageInTicks) * 0.25F);
...
/*    */       
/* 59 */       (this.blazeSticks[j]).rotationPointY = 2.0F + MathHelper.cos(((j << 1) + ageInTicks) * 0.25F);
...
/*    */     } 
/*    */     
/* 75 */     this.blazeHead.rotateAngleY = netHeadYaw / 57.295776F;
/* 76 */     this.blazeHead.rotateAngleX = headPitch / 57.295776F;
/*    */   }
/*    */ }
