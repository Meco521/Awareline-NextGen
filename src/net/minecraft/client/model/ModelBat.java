...
/*  80 */       this.batHead.rotateAngleX = headPitch / 57.295776F;
/*  81 */       this.batHead.rotateAngleY = 3.1415927F - netHeadYaw / 57.295776F;
...
/*  97 */       this.batHead.rotateAngleX = headPitch / 57.295776F;
/*  98 */       this.batHead.rotateAngleY = netHeadYaw / 57.295776F;
...
/* 103 */       this.batBody.rotateAngleX = 0.7853982F + MathHelper.cos(ageInTicks * 0.1F) * 0.15F;
/* 104 */       this.batBody.rotateAngleY = 0.0F;
/* 105 */       this.batRightWing.rotateAngleY = MathHelper.cos(ageInTicks * 1.3F) * 3.1415927F * 0.25F;
