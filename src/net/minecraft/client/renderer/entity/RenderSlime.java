...
/* 34 */     float f = entitylivingbaseIn.getSlimeSize();
/* 35 */     float f1 = (entitylivingbaseIn.prevSquishFactor + (entitylivingbaseIn.squishFactor - entitylivingbaseIn.prevSquishFactor) * partialTickTime) / (f * 0.5F + 1.0F);
/* 36 */     float f2 = 1.0F / (f1 + 1.0F);
/* 37 */     GlStateManager.scale(f2 * f, 1.0F / f2 * f, f2 * f);
/*    */   }
/*    */ 
/*    */ 
/*    */ 
