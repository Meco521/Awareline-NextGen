...
/*  67 */       this.mainModel.render((Entity)entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, scaleFactor);
/*  68 */       GlStateManager.alphaFunc(516, 0.1F);
/*  69 */       GlStateManager.depthFunc(514);
/*     */     } 
/*     */     
/*  72 */     bindEntityTexture(entitylivingbaseIn);
/*  73 */     this.mainModel.render((Entity)entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, scaleFactor);
/*     */     
...
/*  82 */       this.mainModel.render((Entity)entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, scaleFactor);
...
/*  94 */     BossStatus.setBossStatus((IBossDisplayData)entity, false);
/*  95 */     super.doRender(entity, x, y, z, entityYaw, partialTicks);
/*     */     
/*  97 */     if (entity.healingEnderCrystal != null)
/*     */     {
/*  99 */       drawRechargeRay(entity, x, y, z, partialTicks);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 108 */     float f = dragon.healingEnderCrystal.innerRotation + p_180574_8_;
/* 109 */     float f1 = MathHelper.sin(f * 0.2F) / 2.0F + 0.5F;
/* 110 */     f1 = (f1 * f1 + f1) * 0.2F;
/* 111 */     float f2 = (float)(dragon.healingEnderCrystal.posX - dragon.posX - (dragon.prevPosX - dragon.posX) * (1.0F - p_180574_8_));
/* 112 */     float f3 = (float)(f1 + dragon.healingEnderCrystal.posY - 1.0D - dragon.posY - (dragon.prevPosY - dragon.posY) * (1.0F - p_180574_8_));
/* 113 */     float f4 = (float)(dragon.healingEnderCrystal.posZ - dragon.posZ - (dragon.prevPosZ - dragon.posZ) * (1.0F - p_180574_8_));
/* 114 */     float f5 = MathHelper.sqrt_float(f2 * f2 + f4 * f4);
/* 115 */     float f6 = MathHelper.sqrt_float(f2 * f2 + f3 * f3 + f4 * f4);
/* 116 */     GlStateManager.pushMatrix();
/* 117 */     GlStateManager.translate((float)p_180574_2_, (float)p_180574_4_ + 2.0F, (float)p_180574_6_);
/* 118 */     GlStateManager.rotate((float)-Math.atan2(f4, f2) * 180.0F / 3.1415927F - 90.0F, 0.0F, 1.0F, 0.0F);
/* 119 */     GlStateManager.rotate((float)-Math.atan2(f5, f3) * 180.0F / 3.1415927F - 90.0F, 1.0F, 0.0F, 0.0F);
...
/* 123 */     GlStateManager.disableCull();
/* 124 */     bindTexture(enderDragonCrystalBeamTextures);
/* 125 */     GlStateManager.shadeModel(7425);
/* 126 */     float f7 = 0.0F - (dragon.ticksExisted + p_180574_8_) * 0.01F;
/* 127 */     float f8 = MathHelper.sqrt_float(f2 * f2 + f3 * f3 + f4 * f4) / 32.0F - (dragon.ticksExisted + p_180574_8_) * 0.01F;
/* 128 */     worldrenderer.begin(5, DefaultVertexFormats.POSITION_TEX_COLOR);
/* 129 */     int i = 8;
/*     */     
/* 131 */     for (int j = 0; j <= 8; j++) {
/*     */       
/* 133 */       float f9 = MathHelper.sin((j % 8) * 3.1415927F * 2.0F / 8.0F) * 0.75F;
/* 134 */       float f10 = MathHelper.cos((j % 8) * 3.1415927F * 2.0F / 8.0F) * 0.75F;
/* 135 */       float f11 = (j % 8) / 8.0F;
/* 136 */       worldrenderer.pos((f9 * 0.2F), (f10 * 0.2F), 0.0D).tex(f11, f8).color(0, 0, 0, 255).endVertex();
/* 137 */       worldrenderer.pos(f9, f10, f6).tex(f11, f7).color(255, 255, 255, 255).endVertex();
/*     */     } 
/*     */     
/* 140 */     tessellator.draw();
/* 141 */     GlStateManager.enableCull();
/* 142 */     GlStateManager.shadeModel(7424);
/* 143 */     RenderHelper.enableStandardItemLighting();
...
/* 152 */     return enderDragonTextures;
/*     */   }
/*     */ }
