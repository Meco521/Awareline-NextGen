...
/*     */           } 
/*     */           
/*  82 */           worldrenderer.begin(5, DefaultVertexFormats.POSITION_COLOR);
/*  83 */           float f = 0.5F;
/*  84 */           float f1 = 0.45F;
/*  85 */           float f2 = 0.45F;
/*  86 */           float f3 = 0.5F;
...
/*     */             }
/*     */             
/* 129 */             worldrenderer.pos(d10 + d2, y + (i1 << 4), d11 + d3).color(0.45F, 0.45F, 0.5F, 0.3F).endVertex();
/* 130 */             worldrenderer.pos(d8 + d4, y + (i1 + 1 << 4), d9 + d5).color(0.45F, 0.45F, 0.5F, 0.3F).endVertex();
/*     */           } 
/*     */           
