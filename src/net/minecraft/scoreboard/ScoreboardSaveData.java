...
/* 231 */       nbttagcompound.setString("NameTagVisibility", (scoreplayerteam.getNameTagVisibility()).internalName);
/* 232 */       nbttagcompound.setString("DeathMessageVisibility", (scoreplayerteam.getDeathMessageVisibility()).internalName);
