...
/*     */     } 
/*     */     
/* 138 */     list.sort(Score.scoreComparator);
/* 139 */     return list;
/*     */   }
/*     */ 
/*     */   
...
/*     */       {
/* 224 */         setObjectiveInDisplaySlot(i, (ScoreObjective)null);
/*     */       }
/*     */     } 
/*     */     
...
/*     */     }
/*     */     
/* 240 */     onScoreObjectiveRemoved(p_96519_1_);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     {
/* 271 */       throw new IllegalArgumentException("The team name '" + name + "' is too long!");
/*     */     }
/*     */ 
/*     */     
/* 275 */     ScorePlayerTeam scoreplayerteam = getTeam(name);
/*     */     
/* 277 */     if (scoreplayerteam != null)
/*     */     {
/* 279 */       throw new IllegalArgumentException("A team with the name '" + name + "' already exists!");
/*     */     }
/*     */ 
/*     */     
/* 283 */     scoreplayerteam = new ScorePlayerTeam(this, name);
/* 284 */     this.teams.put(name, scoreplayerteam);
...
/* 514 */       removeObjectiveFromEntity(s, (ScoreObjective)null);
