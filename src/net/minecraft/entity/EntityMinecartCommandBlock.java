...
/*  77 */     getDataWatcher().updateObject(23, this.commandBlockLogic.getCommand());
/*  78 */     getDataWatcher().updateObject(24, IChatComponent.Serializer.componentToJson(this.commandBlockLogic.getLastOutput()));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 112 */       this.commandBlockLogic.trigger(this.worldObj);
