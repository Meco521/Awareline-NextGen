...
/*  90 */     super.killMinecart(source);
/*  91 */     double d0 = this.motionX * this.motionX + this.motionZ * this.motionZ;
/*     */     
/*  93 */     if (!source.isExplosion() && this.worldObj.getGameRules().getBoolean("doEntityDrops"))
/*     */     {
/*  95 */       entityDropItem(new ItemStack(Blocks.tnt, 1), 0.0F);
/*     */     }
/*     */     
/*  98 */     if (source.isFireDamage() || source.isExplosion() || d0 >= 0.009999999776482582D)
/*     */     {
/* 100 */       explodeCart(d0);
/*     */     }
/*     */   }
