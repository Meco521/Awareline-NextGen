...
/*     */     
/*  29 */     if ((!this.entityObj.worldObj.isDaytime() || (this.entityObj.worldObj.isRaining() && !this.entityObj.worldObj.getBiomeGenForCoords(blockpos).canRain())) && !this.entityObj.worldObj.provider.getHasNoSky()) {
/*     */       
