...
/*  73 */     return getTranslateName() + ".info";
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 125 */     for (int i = 0; i < worldTypes.length; i++) {
/*     */       
/* 127 */       if (worldTypes[i] != null && (worldTypes[i]).worldType.equalsIgnoreCase(type))
/*     */       {
/* 129 */         return worldTypes[i];
/*     */       }
/*     */     } 
/*     */     
/* 133 */     return null;
