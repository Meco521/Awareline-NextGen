...
/* 117 */     int i = (int)(worldTime % 24000L);
/* 118 */     float f = (i + partialTicks) / 24000.0F - 0.25F;
/*     */     
/* 120 */     if (f < 0.0F)
/*     */     {
/* 122 */       f++;
...
/* 137 */     return (int)(worldTime / 24000L % 8L + 8L) % 8;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 223 */     return (this.terrainType == WorldType.FLAT) ? 4 : (this.worldObj.getSeaLevel() + 1);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
