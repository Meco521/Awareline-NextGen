...
/*  70 */     return p_177413_1_.defaultLightValue;
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 167 */     return new Random(getWorld().getSeed() + (this.xPosition * this.xPosition * 4987142) + (this.xPosition * 5947611) + (this.zPosition * this.zPosition) * 4392871L + (this.zPosition * 389711) ^ seed);
/*     */   }
/*     */ 
/*     */   
