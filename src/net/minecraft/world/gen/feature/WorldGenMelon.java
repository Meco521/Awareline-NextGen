...
/*    */       
/* 17 */       if (Blocks.melon_block.canPlaceBlockAt(worldIn, blockpos) && worldIn.getBlockState(blockpos.down()).getBlock() == Blocks.grass)
/*    */       {
/* 19 */         worldIn.setBlockState(blockpos, Blocks.melon_block.getDefaultState(), 2);
/*    */       }
/*    */     } 
/*    */     
/* 23 */     return true;
