...
/* 35 */     return "commands.gamemode.usage";
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 43 */     if (args.length <= 0)
/*    */     {
/* 45 */       throw new WrongUsageException("commands.gamemode.usage", new Object[0]);
/*    */     }
/*    */ 
/*    */     
/* 49 */     WorldSettings.GameType worldsettings$gametype = getGameModeFromCommand(sender, args[0]);
/* 50 */     EntityPlayerMP entityPlayerMP = (args.length >= 2) ? getPlayer(sender, args[1]) : getCommandSenderAsPlayer(sender);
/* 51 */     entityPlayerMP.setGameType(worldsettings$gametype);
/* 52 */     ((EntityPlayer)entityPlayerMP).fallDistance = 0.0F;
/*    */     
/* 54 */     if (sender.getEntityWorld().getGameRules().getBoolean("sendCommandFeedback"))
/*    */     {
/* 56 */       entityPlayerMP.addChatMessage((IChatComponent)new ChatComponentTranslation("gameMode.changed", new Object[0]));
/*    */     }
/*    */     
/* 59 */     ChatComponentTranslation chatComponentTranslation = new ChatComponentTranslation("gameMode." + worldsettings$gametype.getName(), new Object[0]);
/*    */     
/* 61 */     if (entityPlayerMP != sender) {
/*    */       
/* 63 */       notifyOperators(sender, this, 1, "commands.gamemode.success.other", new Object[] { entityPlayerMP.getName(), chatComponentTranslation });
/*    */     }
/*    */     else {
/*    */       
/* 67 */       notifyOperators(sender, this, 1, "commands.gamemode.success.self", new Object[] { chatComponentTranslation });
/*    */     } 
/*    */   }
/*    */ 
/*    */ 
