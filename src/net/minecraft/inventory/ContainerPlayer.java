...
/*     */       {
/*  32 */         addSlotToContainer(new Slot(this.craftMatrix, j + (i << 1), 88 + j * 18, 26 + i * 18));
/*     */       }
/*     */     } 
/*     */     
...
/*     */     } 
/*     */     
/*  97 */     this.craftResult.setInventorySlotContents(0, (ItemStack)null);
/*     */   }
/*     */ 
/*     */   
...
/*     */         
/* 171 */         slot.putStack((ItemStack)null);
/*     */       }
/*     */       else {
/*     */         
...
/* 195 */     return (slotIn.inventory != this.craftResult && super.canMergeSlot(stack, slotIn));
/*     */   }
/*     */ }
