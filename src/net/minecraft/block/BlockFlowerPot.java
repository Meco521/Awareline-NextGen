...
/*  26 */   public static final PropertyInteger LEGACY_DATA = PropertyInteger.create("legacy_data", 0, 15);
/*  27 */   public static final PropertyEnum<EnumFlowerType> CONTENTS = PropertyEnum.create("contents", EnumFlowerType.class);
/*     */ 
/*     */   
/*     */   public BlockFlowerPot() {
/*  31 */     super(Material.circuits);
/*  32 */     setDefaultState(this.blockState.getBaseState().withProperty((IProperty)CONTENTS, EnumFlowerType.EMPTY).withProperty((IProperty)LEGACY_DATA, Integer.valueOf(0)));
...
/*     */     
/*  79 */     if (tileentity instanceof TileEntityFlowerPot) {
/*     */       
/*  81 */       Item item = ((TileEntityFlowerPot)tileentity).getFlowerPotItem();
/*     */       
/*  83 */       if (item instanceof net.minecraft.item.ItemBlock)
/*     */       {
/*  85 */         return Block.getBlockFromItem(item).colorMultiplier(worldIn, pos, renderPass);
/*     */       }
/*     */     } 
/*     */     
/*  89 */     return 16777215;
...
/*  94 */     ItemStack itemstack = playerIn.inventory.getCurrentItem();
/*     */     
/*  96 */     if (itemstack != null && itemstack.getItem() instanceof net.minecraft.item.ItemBlock) {
/*     */       
/*  98 */       TileEntityFlowerPot tileentityflowerpot = getTileEntity(worldIn, pos);
/*     */       
/* 100 */       if (tileentityflowerpot == null)
/*     */       {
/* 102 */         return false;
/*     */       }
/* 104 */       if (tileentityflowerpot.getFlowerPotItem() != null)
/*     */       {
/* 106 */         return false;
/*     */       }
/*     */ 
/*     */       
/* 110 */       Block block = Block.getBlockFromItem(itemstack.getItem());
/*     */       
/* 112 */       if (!canNotContain(block, itemstack.getMetadata()))
/*     */       {
/* 114 */         return false;
/*     */       }
/*     */ 
/*     */       
/* 118 */       tileentityflowerpot.setFlowerPotData(itemstack.getItem(), itemstack.getMetadata());
/* 119 */       tileentityflowerpot.markDirty();
/* 120 */       worldIn.markBlockForUpdate(pos);
/* 121 */       playerIn.triggerAchievement(StatList.field_181736_T);
/*     */       
/* 123 */       if (!playerIn.capabilities.isCreativeMode && --itemstack.stackSize <= 0)
/*     */       {
/* 125 */         playerIn.inventory.setInventorySlotContents(playerIn.inventory.currentItem, (ItemStack)null);
/*     */       }
/*     */       
/* 128 */       return true;
/*     */     } 
...
/* 140 */     return (blockIn != Blocks.yellow_flower && blockIn != Blocks.red_flower && blockIn != Blocks.cactus && blockIn != Blocks.brown_mushroom && blockIn != Blocks.red_mushroom && blockIn != Blocks.sapling && blockIn != Blocks.deadbush) ? ((blockIn == Blocks.tallgrass && meta == BlockTallGrass.EnumType.FERN.getMeta())) : true;
/*     */   }
/*     */ 
/*     */   
/*     */   public Item getItem(World worldIn, BlockPos pos) {
/* 145 */     TileEntityFlowerPot tileentityflowerpot = getTileEntity(worldIn, pos);
/* 146 */     return (tileentityflowerpot != null && tileentityflowerpot.getFlowerPotItem() != null) ? tileentityflowerpot.getFlowerPotItem() : Items.flower_pot;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       {
/* 205 */         tileentityflowerpot.setFlowerPotData((Item)null, 0);
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
