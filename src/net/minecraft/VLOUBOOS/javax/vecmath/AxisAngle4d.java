...
/* 510 */     return (((diff < 0.0D) ? -diff : diff) <= epsilon);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   public int hashCode() {
/* 524 */     long bits = 1L;
/* 525 */     bits = VecMathUtil.hashDoubleBits(bits, this.x);
/* 526 */     bits = VecMathUtil.hashDoubleBits(bits, this.y);
/* 527 */     bits = VecMathUtil.hashDoubleBits(bits, this.z);
/* 528 */     bits = VecMathUtil.hashDoubleBits(bits, this.angle);
/* 529 */     return VecMathUtil.hashFinish(bits);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Administrator\Downloads\Awareline - NextGen7 release ‎2023‎-12-25-‏11-09-05.jar!\net\minecraft\VLOUBOOS\javax\vecmath\AxisAngle4d.class
