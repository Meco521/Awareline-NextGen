...
/* 130 */     return "(" + (this.x & 0xFF) + ", " + (this.y & 0xFF) + ", " + (this.z & 0xFF) + ", " + (this.w & 0xFF) + ")";
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     try {
/* 201 */       return (this.x == t1.x && this.y == t1.y && this.z == t1.z && this.w == t1.w);
...
/* 219 */       return (this.x == t2.x && this.y == t2.y && this.z == t2.z && this.w == t2.w); }
/*     */     catch (NullPointerException e2)
/*     */     
/* 222 */     { return false; }
...
/*     */   
/*     */   public int hashCode() {
/* 238 */     return (this.x & 0xFF) << 0 | (this.y & 0xFF) << 8 | (this.z & 0xFF) << 16 | (this.w & 0xFF) << 24;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Administrator\Downloads\Awareline - NextGen7 release ‎2023‎-12-25-‏11-09-05.jar!\net\minecraft\VLOUBOOS\javax\vecmath\Tuple4b.class
