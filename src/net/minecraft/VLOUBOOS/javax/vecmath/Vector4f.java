...
/* 148 */     return 
/* 149 */       (float)Math.sqrt((this.x * this.x + this.y * this.y + this.z * this.z + this.w * this.w));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 182 */     float norm = (float)(1.0D / Math.sqrt((v1.x * v1.x + v1.y * v1.y + v1.z * v1.z + v1.w * v1.w)));
/*     */     
/* 184 */     v1.x *= norm;
/* 185 */     v1.y *= norm;
/* 186 */     v1.z *= norm;
...
/* 198 */     float norm = (float)(1.0D / Math.sqrt((this.x * this.x + this.y * this.y + this.z * this.z + this.w * this.w)));
/*     */     
/* 200 */     this.x *= norm;
/* 201 */     this.y *= norm;
/* 202 */     this.z *= norm;
...
/* Location:              C:\Users\Administrator\Downloads\Awareline - NextGen7 release ‎2023‎-12-25-‏11-09-05.jar!\net\minecraft\VLOUBOOS\javax\vecmath\Vector4f.class
