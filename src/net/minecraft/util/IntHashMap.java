...
/*     */     else {
/*     */       
/* 108 */       Entry[] arrayOfEntry = new Entry[p_76047_1_];
/* 109 */       copyTo((Entry<V>[])arrayOfEntry);
/* 110 */       this.slots = (Entry<V>[])arrayOfEntry;
/* 111 */       getClass(); this.threshold = (int)(p_76047_1_ * 0.75F);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* 254 */       Object object = Integer.valueOf(this.hashEntry);
/* 255 */       Object object1 = Integer.valueOf(entry.hashEntry);
/*     */       
/* 257 */       if (object == object1 || object1.equals(object)) {
/*     */         
/* 259 */         Object object2 = this.valueEntry;
/* 260 */         Object object3 = entry.valueEntry;
/*     */         
...
/* 279 */       return this.hashEntry + "=" + this.valueEntry;
/*     */     }
/*     */   }
/*     */ }
